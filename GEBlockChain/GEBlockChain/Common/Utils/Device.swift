...
//  GEBlockChain
//
//  Created by nan li on 2020/9/15.
...
open class Device {
    ...
    class public var navBarHeight: CGFloat { (isIphoneX ? 88 : 64)}
    class public var tabBarHeight: CGFloat { (isIphoneX ? 49 + 34 : 49)}
...
//        }
    ...
    class public var orientation: Device.Orientation {
        if isPortrait {
            return .portrait
        } else {
    ...
    class func compareWitdhTo6S(_ witdh: CGFloat) -> CGFloat {
        return width * UIScreen.main.bounds.size.width/375.0;
    }
    
    
    class func compareHeightTo6s(_ height: CGFloat) -> CGFloat {
        return height * UIScreen.main.bounds.size.height/667.0;
    }
