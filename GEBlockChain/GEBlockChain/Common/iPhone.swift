...
extension Int {
    ...
    public func s6w() -> CGFloat {
       return CGFloat(self) * UIScreen.main.bounds.size.width/375.0
    }
    
    public func s6h() -> CGFloat {
        return CGFloat(self) * UIScreen.main.bounds.size.height/667.0
    }
    
    public static func sw() -> CGFloat {
        return UIScreen.main.bounds.size.width
    }
    
    public static func sh() -> CGFloat {
